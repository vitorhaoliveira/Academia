...
<body>
   <header>
      ...
      <div class="box2"> 
         ...
         <div class="box-login">
            <img width="40" height="40" class="" src="./assets/usuario-de-perfil.png"  alt="">
         </div>
      </div>
   ...
   <br><br>
      ...
      <div class="divInfo">
         <form class="FormInformacao" action="info.php" class="login" method="post">

            
            <label for="pesquisa">Escolha o que você quer pesquisar:</label>
            
            <input type="email" name="email" class="em" value="<?php echo $email ?>" id="">

            <select class="select" name="opcao" id="pesquisa">

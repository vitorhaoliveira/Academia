...
$nome_aluno = isset($_SESSION['nome']) ? $_SESSION['nome'] : 'Nome do Aluno';
?>
...
<header>
   ...
   <main>
      <section class="main-content">
         <h1 class="titulo">Bem-vindo, Aluno: <?php echo $nome_aluno; ?></h1>

         
         <div class="box-button">
            <a class="button_busca" href="ver_perfilAluno.php">Ver Perfil</a> <br>
            <a class="button_busca" href="ver_turmasAluno.php">Ver Turmas Matriculadas</a>
         </div>
      </section>
